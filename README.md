...
[![License](http://img.shields.io/:license-apache-blue.svg)](http://www.apache.org/licenses/LICENSE-2.0.html) [![Build Status](https://travis-ci.org/simp/pupmod-simp-spmasq.svg)](https://travis-ci.org/simp/pupmod-simp-spmasq) [![SIMP compatibility](https://img.shields.io/badge/SIMP%20compatibility-6.*-orange.svg)](https://img.shields.io/badge/SIMP%20compatibility-6.*-orange.svg)

#### Table of Contents

1. [Description](#description)
2. [Setup - The basics of getting started with spmasq](#setup)
    * [What spmasq affects](#what-spmasq-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with spmasq](#beginning-with-spmasq)
...
**FIXME:** Ensure the *What spmasq affects* section is correct and complete, then remove this message!
...
### Beginning with spmasq

**FIXME:** Ensure the *Beginning with spmasq* section is correct and complete, then remove this message!
